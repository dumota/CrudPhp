...
<div class="alert alert-success text-center message" role="alert" >
  A new Player has been added successfylly!
</div>
<!-- include the form  and profile/modal in php -->
<?php
...
<div class="row mb-3">
<div class="col-3">
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#userModal" id=>Add New <i class="fa fa-user-circle-o" ></i></button>
</div>
<div class="col-9">
...
<!-- include tables of players in php -->
<?php
  include_once 'playersStable.php';
?>
<nav id="pagination">
